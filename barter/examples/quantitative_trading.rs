...
impl ClosePositionsStrategy for MultiStrategy {
        ...
        InstrumentIndex: 'a,
    {
        ...
        return (std::iter::empty(), open_requests);
    }
}
...
impl AlgoStrategy for StrategyA {
    ...
    fn generate_algo_orders(
        ...
        return (std::iter::empty(), std::iter::empty());
    }
}
    ...
    for MultiStrategyCustomInstrumentData
{
    ...
    fn process(&mut self, event: &MarketEvent<InstrumentKey, DataKind>) -> Self::Audit {
        return self.market_data.process(event);
    }
}
